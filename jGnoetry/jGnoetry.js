...
var jGnoetry = function (dbg) {
    ...
    var syllableExceptionsAlgorithm = { 'people': 2, 'our': 2, 'israel': 3, 'little': 2, 'mr': 2, 'being': 2, 'saying': 2,
        ...
        if (hasNonTemplateWord(aTemplateText)) {
            ...
            for (var i = 0; i < aTemplateText.length; i++) {
                ...
                if (templateToken == token.syllable) {
                    // only used in this function, in the next few lines
                    // but set as global. UGH.
                    syllableBalance--;
                    var loopCount = 0;
                    while (syllableBalance < 0 && loopCount < 5) {
                        if (i == 0) {
            ...
            for (i = 0; i < existingText.length; i++) {
