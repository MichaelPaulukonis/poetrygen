...
var jGnoetry = function (dbg) {
    ...
    this.generate = function (templateText, options, corpora, existingText) {
        ...
        var gnoe = getOutput(aTemplateText, aGeneratedWords, aGeneratedWordsStatic, corpora, options, existingText);
    ...
    var getOutput = function (aTemplateText, aGeneratedWords, aGeneratedWordsStatic, corpora, options, existingText) {
    ...
    var processTemplate = function (aTemplateText, templateText, corpora, options, existingText) {
        ...
        if (hasNonTemplateWord(aTemplateText)) {
            ...
            for (var i = 0; i < aTemplateText.length; i++) {
                ...
                if (templateToken == token.syllable) {
                    ...
                    while (syllableBalance < 0 && loopCount < 5) {
                        ...
                        // TODO: what's the scope on syllableBalance???
            ...
            for (var i = 0; i < existingText.length; i++) {
                ...
                // TODO: refactor this to a semantic reference
